...
<div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <a href="/create" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Add New Model</a>
    <table class="min-w-full mt-4 bg-white border border-gray-300">
        ...
        <tr class="border-b border-gray-200 hover:bg-gray-100">
            ...
            <td class="py-3 px-6"><?= htmlspecialchars($model['anyFabricacio']) ?></td>
            <td class="py-3 px-6"><?= htmlspecialchars(number_format($model['preu'], 2, ',', '.')) ?></td>
            <td class="py-3 px-6 text-center">
                <a href="/edit/<?= $model['id'] ?>" class="text-blue-500 hover:text-blue-700 mr-4">Edit</a>
                <a href="/delete/<?= $model['id'] ?>" class="text-red-500 hover:text-red-700">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
        <?php endif; ?>
